...
const CRTTerminal: React.FC = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-black" style={crtBg}>
            <div
                className="w-full max-w-2xl rounded-xl shadow-2xl border-4 border-green-700 p-4 md:p-8"
                style={{ boxShadow: "0 0 40px #0f0, 0 0 8px #0f0 inset" }}
            >
                <div
                    ref={containerRef}
                    className="h-96 md:h-[32rem] overflow-y-auto font-mono text-green-400 text-lg leading-relaxed px-2 py-2 bg-black rounded-lg relative"
                    style={{
                ...
                <div className="text-green-700 text-xs mt-4 text-center tracking-widest select-none">
                    CRT Terminal Emulator &copy; 2024
                </div>
            </div>
        </div>
    );
